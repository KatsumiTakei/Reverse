...
public class AudioManager : SingletonMonoBehaviour<AudioManager>
{
    ...
    static string nextBGMName = string.Empty;
    static bool isFadeOut = false;

    static AudioSource bgmSource = null;
    static List<AudioSource> _seSourceList = null;

    static Dictionary<string, AudioClip> bgmDic = null;
    static Dictionary<string, AudioClip> seDic = null;
    ...
    private new void Awake()
    {
        ...
        AudioClip[] bgmList = Resources.LoadAll<AudioClip>(ResourcesPath.Audio.BGM.Path);
        AudioClip[] seList = Resources.LoadAll<AudioClip>(ResourcesPath.Audio.SE.Path);
